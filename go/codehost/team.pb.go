...
const file_codehost_team_proto_rawDesc = "" +
	"\n" +
	"\x13codehost/team.proto\x12\bcodehost\">\n" +
	"\x04Team\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04slug\x18\x03 \x01(\tR\x04slugB&Z$github.com/reviewpad/api/go/codehostb\x06proto3"

var (
	file_codehost_team_proto_rawDescOnce sync.Once
	file_codehost_team_proto_rawDescData []byte
)

func file_codehost_team_proto_rawDescGZIP() []byte {
	file_codehost_team_proto_rawDescOnce.Do(func() {
		file_codehost_team_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_codehost_team_proto_rawDesc), len(file_codehost_team_proto_rawDesc)))
	})
	return file_codehost_team_proto_rawDescData
}

var file_codehost_team_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_codehost_team_proto_goTypes = []any{
...
func file_codehost_team_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_codehost_team_proto_rawDesc), len(file_codehost_team_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
